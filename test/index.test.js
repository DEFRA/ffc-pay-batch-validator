...
jest.mock('../ffc-pay-batch-validator/config', () => ({ totalRetries: 1 }))
const mockContext = require('./mock-context')

const ORIGINAL_CTL_BATCH_FILE_NAME = 'batch/inbound/CTL_PENDING_TEST_BATCH.dat'
...
const validate = require('../ffc-pay-batch-validator')
...
describe('validation', () => {
  ...
  beforeEach(() => {
    mockContext.bindingData.blobTrigger = ORIGINAL_CTL_BATCH_FILE_NAME
